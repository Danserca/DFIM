...
<div class="row-sm-3">
  <figure style="text-align: center;">
    <figcaption style="margin-bottom: 10px;">Figura 2. Tasa de personas que cambiaron de lugar de residencia y atribuyeron a la violencia dicho cambio por cada cien mil habitantes, 2015-2019</figcaption>
    <img src="imagenes/figura2_mapa.png" alt="Mapa de Tasa de Personas">
  </figure>
</div>
...
<div class="row-sm-3">
  <figure>
    <figcaption>Figura 3. Tasa suavizada promedio de homicidios, 2015-2019</figcaption>
    <img src="imagenes/figura3_mapa.png" alt="Mapa de Homicidios">
  </figure>
</div>
