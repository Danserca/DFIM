...
### Ambas:
- **Ventajas:**
  - Combina lo mejor de ambos mundos, ofreciendo una visión más completa y matizada del fenómeno. Permite identificar las discrepancias entre la percepción y la realidad, y explorar los factores que influyen en estas diferencias.
- **Limitaciones:**
  - Requiere un diseño de investigación más complejo y costoso, y puede ser más difícil de analizar e interpretar los resultados.
]
---
class: middle, center, inverse
